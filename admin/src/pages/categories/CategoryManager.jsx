              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-gray-400 file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200 cursor-pointer" 
                  />
                  <p className="text-[10px] text-gray-400 mt-1">Recommended: Square shape (1:1 ratio, e.g., 200x200px)</p>
                  {imagePreview && (
                    <div className="mt-2 flex items-center gap-3">
                      <img src={imagePreview} alt="" className="w-16 h-16 rounded-full object-cover border" />
                    </div>
                  )}
                </div>
              </div>
